...
BUILD_DIR="${PWD}/build"     # Current directory where the script is located
...
[ "$ENABLE_PNG" == "ON" ] && CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_PNG=ON" || CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_PNG=OFF"
[ "$ENABLE_JPEG" == "ON" ] && CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_JPG=ON" || CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_JPG=OFF"
[ "$ENABLE_TIFF" == "ON" ] && CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_TIF=ON" || CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_TIF=OFF"
[ "$ENABLE_WEBP" == "ON" ] && CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_WEBP=ON" || CMAKE_OPTS="$CMAKE_OPTS -DSDL_IMAGE_WEBP=OFF"
